...
void myTMVAsig( TString myMethodList = "" )
{
...
//    factory->AddVariable( "EvtInfo_HT", 'F' );
//    factory->AddVariable( "EvtInfo_HT_S", 'F' );
//    factory->AddVariable( "EvtInfo_HT_SL", 'F' );
//    factory->AddVariable( "EvtInfo_HT_O", 'F' );
   ...
   factory->AddVariable( "ZInfo_M", 'F' );
   factory->AddVariable( "WInfo_Pt", 'F' );
   factory->AddVariable( "WInfo_Mt", 'F' );
   factory->AddVariable( "TopInfo_Pt1", 'F' );
   factory->AddVariable( "TopInfo_Pt2", 'F' );
...
//    factory->AddSpectator( "spec2 := var1*3",  "Spectator 2", "units", 'F' );
   ...
   TFile *sigFile = TFile::Open( "hist_top_cz1.root" );
   TFile *bkgFile = TFile::Open( "hist_wz_1.root" );
...
//    TFile *sig = TFile::Open( "hist_top_cz1.root" );
   ...
   //TTree *background = (TTree*)bkgFile->Get("mvaTree");
   ...
   TCut mycuts = "TopInfo_MCTruth==1||TopInfo_MCTruth==3"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   TCut mycutb = "TopInfo_MCTruth==0||TopInfo_MCTruth==2"; // for example: TCut mycutb = "abs(var1)<0.5";
